...
Expectations do
  ...
  # Include#initialize
  expect "foo" do
    include_cmd = PageTemplate::Command::Include.new(nil, "", "foo")
  ...
  begin
    expect "Output of template" do
      include_cmd = PageTemplate::Command::Include.new(nil, "", "")
  ...
  begin
    ...
    expect stub('source').to.receive(:get).with("some_file.txt") do |source|
      include_cmd = PageTemplate::Command::Include.new(nil, "", "some_file.txt")
